...
// ← Transporter — Gmail se email bhejne ke liye
...
// ← Email templates — har status ke liye alag
const emailTemplates = {
    pending: {
        ...
        message: "Your order has been received and is now pending. We will start processing it soon.",
        statusLabel: "Pending",
    },
    processing: {
    ...
    <html>
      ...
      <body style="margin: 0; padding: 0; background-color: #f9fafb; font-family: Arial, sans-serif;">
        <div style="max-width: 600px; margin: 40px auto; background: white;
                    border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.07);">

          <!-- Header -->
          <div style="background: #111827; padding: 30px; text-align: center;">
            <h1 style="color: #818CF8; margin: 0; font-size: 24px;">🛍️ MyStore</h1>
          </div>
          ...
          <div style="padding: 30px;">
            ...
            <p style="color: #374151; font-size: 16px; margin-bottom: 8px;">
              Assalam-o-Alaikum <strong>${order.shippingAddress.fullName}</strong>!
            </p>
            ...
            <div style="text-align: center; margin-bottom: 24px;">
              <span style="background: ${template.color}20; color: ${template.color};
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 16px;">
              ...
              <tfoot>
                <tr>
                  <td colspan="2" style="padding: 12px 10px; font-weight: bold;
                                         color: #111827;">
                    Total
                  </td>
